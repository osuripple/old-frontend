	...
	<form method="post" action="<?php echo Uri::to('admin/extend/metadata'); ?>" novalidate>
		...
		<fieldset class="split">
			<p>
				...
				<?php echo Form::text('sitename', Input::previous('sitename', $meta['sitename']), ['id' => 'label-sitename']); ?>
				<em><?php echo __('metadata.sitename_explain'); ?></em>
			</p>
			<p>
				<label for="label-sitedescription"><?php echo __('metadata.sitedescription'); ?>:</label>
				<?php echo Form::textarea('description', Input::previous('description', $meta['description']), ['id' => 'label-sitedescription']); ?>
				<em><?php echo __('metadata.sitedescription_explain'); ?></em>
			</p>
			<p>
				<label for="label-homepage"><?php echo __('metadata.homepage'); ?>:</label>
				<?php echo Form::select('home_page', $pages, Input::previous('home_page', $meta['home_page']), ['id' => 'label-homepage']); ?>
				<em><?php echo __('metadata.homepage_explain'); ?></em>
			</p>
			<p>
				<label for="label-postspage"><?php echo __('metadata.postspage'); ?>:</label>
				<?php echo Form::select('posts_page', $pages, Input::previous('posts_page', $meta['posts_page']), ['id' => 'label-postspage']); ?>
			...
			<p>
				...
				<?php echo Form::checkbox('show_all_posts', 1, $checked, ['id' => 'label-show_all_posts']); ?>
		...
		<fieldset class="split">
			...
			<p>
				...
				<?php echo Form::checkbox('auto_published_comments', 1, $checked, ['id' => 'label-auto_published_comments']); ?>
			...
			<p>
				...
				<?php echo Form::checkbox('comment_notifications', 1, $checked, ['id' => 'label-comment_notifications']); ?>
			...
			<p>
				...
				<?php echo Form::textarea('comment_moderation_keys', Input::previous('comment_moderation_keys', $meta['comment_moderation_keys']), ['id' => 'label-comment_moderation_keys']); ?>
