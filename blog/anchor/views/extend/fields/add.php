...
endforeach; ?>
			...
			<p class="hide attributes_type">
				...
				<?php echo Form::text('attributes[type]', Input::previous('attributes.type'), ['id' => 'label-attributes_type']); ?>
			...
			<p class="hide attributes_width">
				...
				<?php echo Form::text('attributes[size][width]', Input::previous('attributes.size.width'), ['id' => 'label-attributes_size_width']); ?>
			...
			<p class="hide attributes_height">
				...
				<?php echo Form::text('attributes[size][height]', Input::previous('attributes.size.height'), ['id' => 'label-attributes_size_height']); ?>
