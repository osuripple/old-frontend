...
<section class="wrap">
	...
	<form method="post" action="<?php echo Uri::to('admin/extend/fields/edit/'.$field->id); ?>" novalidate>
		...
		<fieldset class="split">
			...
			<p <?php if ($field->type != 'page'): ?>style="display: none"<?php
endif; ?>>
...
endforeach; ?>
			...
			<p class="hide attributes_type">
				...
				<?php echo Form::text('attributes[type]', Input::previous('attributes.type', $value), ['id' => 'label-attributes_type']); ?>
			...
			<p class="hide attributes_width">
				...
				<?php echo Form::text('attributes[size][width]', Input::previous('attributes.size.width', $value), ['id' => 'label-attributes_size_width']); ?>
			...
			<p class="hide attributes_height">
				...
				<?php echo Form::text('attributes[size][height]', Input::previous('attributes.size.height', $value), ['id' => 'label-attributes_size_height']); ?>
		...
		<aside class="buttons">
			...
			<?php echo Html::link('admin/extend/fields/delete/'.$field->id, __('global.delete'), ['class' => 'btn delete red']); ?>
