	...
	<fieldset class="meta split">
		<div class="wrap">
			<p>
				...
				<?php echo Form::checkbox('show_in_menu', 1, Input::previous('show_in_menu', $page->show_in_menu) == 1, ['id' => 'label-show_in_menu']); ?>
			...
			<p>
				...
				<?php echo Form::select('status', $statuses, Input::previous('status', $page->status), ['id' => 'label-status']); ?>
				<em><?php echo __('pages.status_explain'); ?></em>
			</p>
			<p>
				<label for="label-parent"><?php echo __('pages.parent'); ?>:</label>
				<?php echo Form::select('parent', $pages, Input::previous('parent', $page->parent), ['id' => 'label-parent']); ?>
