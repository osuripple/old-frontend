...
<section class="login content">
	...
	<form method="post" action="<?php echo Uri::to('admin/login'); ?>">
		...
		<fieldset>
			...
			<?php echo Form::text('user', $user, ['id' => 'label-user', 'autocapitalize' => 'off', 'autofocus' => 'true', 'placeholder' => __('users.username')]); ?></p>

			<p><label for="label-pass"><?php echo __('users.password'); ?>:</label>
			<?php echo Form::password('pass', ['id' => 'pass', 'placeholder' => __('users.password'), 'autocomplete' => 'off']); ?></p>
