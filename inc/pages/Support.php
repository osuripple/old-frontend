	...
	public function P() {
		...
		<div id="narrow-content">
			<div align="center">
				...
				<div class="row grid-divider" align="left">
					...
					<div class="col-sm-4">
						<div class="col-padding">
							...
							<p>You will also get the <b>"Donor"</b> privilege on our <b>Discord server</b>. That also means you\'ll get exclusive access to the "donors" text and voice <b>channels</b>!</p>
						</div>
					</div>
				</div>
				<br><br><br><br><br><br><br><br><br><br><br><br><hr><br><br>
				...
				<hr>
				<h3 style="display: inline;"><i class="fa fa-paypal"></i>	Prefer PayPal?</h3><br><br>
				<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_self">
					...
					<tr><td><input type="hidden" name="on2" value="Discord username (if any)">Discord username (if any)</td></tr><tr><td><input type="text" name="os2" maxlength="200"></td></tr>
					</table>
					...
					<br>
					<button type="submit" class="btn btn-primary" name="submit"><i class="fa fa-paypal"></i>	Buy now</button>
